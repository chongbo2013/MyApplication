...
public class DividerGridItemDecoration extends RecyclerView.ItemDecoration {
	...
	public DividerGridItemDecoration(Context context,int dividerSize) {
	...
	public void onDraw(Canvas c, RecyclerView parent, State state) {
		if (dividerSize > 0) {
//			drawSizeHorizontal(c, parent);
//			drawSizeVertical(c, parent);
		}else{
	...
	public void drawSizeHorizontal(Canvas c, RecyclerView parent)
	{
		int childCount = parent.getChildCount();
		for (int i = 0; i < childCount; i++)
		{
	...
	public void drawSizeVertical(Canvas c, RecyclerView parent)
	{
		final int childCount = parent.getChildCount();
		for (int i = 0; i < childCount; i++)
		{
