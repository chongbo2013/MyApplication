...
//            Log.e(TAG, "Pos: "  + startPos + "-" + endPos);
//            if(MainApp.mapDownloadRecord.containsKey(threadId)){
//                downloadLength = MainApp.mapDownloadRecord.get(threadId);
//                startPos = startPos + downloadLength - 1;
//                Log.e(TAG, "Pos: "  + startPos + "-" + endPos);
//            }

			//设置当前线程下载的起点、终点
			conn.setRequestProperty("Range", "bytes=" + startPos + "-" + endPos);
            Log.e(TAG, Thread.currentThread().getName() + "  bytes="
                    + startPos + "-" + endPos);
			...
			isCompleted = true;
			Log.e(TAG, "current thread task has finished,all size:"
					+ downloadLength);
