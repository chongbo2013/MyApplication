...
import com.tpad.common.model.net.volley.customRequest.GsonRequest;
...
public class NetGsonOperator {
    ...
    public <T>void request(String url, Class<T> clazz, final com.tpad.common.model.net.NetResponseCallback<T> responseCallback) {
